...
Formal Output
=============
You must output a reverse-ordered list of the total number of times the varying institutions/people visited your
website. Each visitor IP should only count once, and it should count for the **smallest** range it is a member of. IPs
that were not found in the given rangescan count as `<unknown>`.
...
* [300,000 ranges](https://github.com/fsufitch/dailyprogrammer/raw/master/ideas/whois/ips300k.txt) (file size warning:
15 MB)
* [1,000,000 ranges](https://github.com/fsufitch/dailyprogrammer/raw/master/ideas/whois/ips1mil.txt) (file size
warning: 49 MB)
**Query files:**
...
database. 
**Bonus points:** 
* Modify your solution to work for [IPv6 (128-bit) addresses](https://en.wikipedia.org/wiki/IPv6_address) in addition
to IPv4 (32-bit) addresses.
* Test your solution against some super-huge data sets (10-100 million IP ranges). You will have to generate those
inputs yourself, though. You can use my [generation
script](https://github.com/fsufitch/dailyprogrammer/blob/master/ideas/whois/ipgen2.py) if you  would like.
