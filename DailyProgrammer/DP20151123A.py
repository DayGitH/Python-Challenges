...
**Description**
Scientist have discovered a new plant. The fruit of the plant can feed 1 person for a whole week and best of all, the
plant never dies.
...
*Output*
    5
**Input description**
The input gives you 2 positive integers `x` and `y`, being `x` the number of people needed to be fed and `y` the number
of fruits you start with.
**Output description**
