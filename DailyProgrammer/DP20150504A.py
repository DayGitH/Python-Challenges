...
The HBO network show "Silicon Valley" has introduced a way to pronounce hex.
	...
	Bachman: Yeah, I know what binary is. Jesus Christ, I memorized the hexadecimal 
                        ...
                        binary is.
Not "eff five", fleventy. `0xF0` is now fleventy. Awesome. Above a full byte you add "bitey" to the name. The
hexidecimal pronunciation rules:
...
# Credit
This challenge was suggested by /u/metaconcept. If you have a challenge idea, submit it to /r/dailyprogrammer_ideas and
we just might use it.
"""
