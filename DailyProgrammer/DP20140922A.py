...
algebra, you may have seen equations in the form [`y=ax+b`](http://latex.codecogs.com/gif.latex?y%3Dax&plus;b), where
...
[`y=2x+2`](http://latex.codecogs.com/gif.latex?y%3D2x&plus;2) and
...
forming one equation, [`2x+2=5x-4`](http://latex.codecogs.com/gif.latex?2x&plus;2%3D5x-4), as they both refer to the
same variable `y`. Then, subtract one of the sides of the equation from the other side - like
[`2x+2-(2x+2)=5x-4-(2x+2)`](http://latex.codecogs.com/gif.latex?2x&plus;2-%282x&plus;2%29%3D5x-4-%282x&plus;2%29) which
...
so](http://latex.codecogs.com/gif.latex?%282x&plus;2%5C%3B%20%5Ctextup%7Bwhere%7D%5C%3B%20x%3D2%29%3D2%282%29&plus;2%3D4&plus;2%3D6).
