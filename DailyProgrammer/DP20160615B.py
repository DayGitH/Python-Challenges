...
[here](http://www.topherlee.com/software/pcm-tut-wavformat.html). Note that by "Format chunk marker. Includes trailing
null", the author of that page means trailling space.
